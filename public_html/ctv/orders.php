...
<div class="card">
  ...
  <?php else: ?>
  <table>
    <thead><tr><th>Mã</th><th>Gói</th><th>Số lượng</th><th>Phí CTV</th><th>Trạng thái</th><th>Nhà cung cấp</th><th>Ngày</th></tr></thead>
    <tbody>
      ...
      <tr>
        ...
        <td><?= htmlspecialchars($r['providerOrderNo']) ?></td>
        <td><?= htmlspecialchars((string)$r['createdAt']) ?></td>
      </tr>
      <?php if ($r['errorMessage']): ?>
      <tr><td colspan="7" class="muted">Lỗi: <?= htmlspecialchars($r['errorMessage']) ?></td></tr>
      <?php endif; ?>
      <?php endforeach; ?>
    </tbody>
  </table>
