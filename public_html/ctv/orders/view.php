...
if (!$order) {
    ...
    echo '<div class="card"><h2>Không tìm thấy đơn</h2><p class="muted">Đơn không tồn tại hoặc không thuộc tài khoản đối tác của bạn.</p><p><a class="btn secondary" href="/ctv/orders.php">Về danh sách đơn</a></p></div>';
    ctv_layout_footer();
    exit;
}
  ...
  <div class="order-grid">
    ...
    <div>
      ...
      <div class="kv">
        ...
        <b>Giá đối tác</b><div><b><?= htmlspecialchars(format_vnd((int)$order['ctv_price'])) ?></b> / eSIM</div>
