...
check "$BASE/ctv/topup-orders.php" "302" "CTV Topup Orders (redirect)"
check "$BASE/admin/ctv/login.php" "200" "Admin Login page"
check "$BASE/admin/ctv/dashboard-admin.php" "302" "Admin Dashboard (redirect to login)"
check "$BASE/admin/ctv/order-view.php" "302" "Admin Order View (redirect to login)"
check "$BASE/admin/ctv/topup-requests.php" "302" "Admin Topup Requests (redirect to login)"
check "$BASE/admin/ctv/topup-orders.php" "302" "Admin Topup Orders (redirect to login)"
